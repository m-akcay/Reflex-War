...
public class ReflexButton_multi
{
    ...
    public void drawLine()
    {
        ...
        wpos.z = fixedZ;
        wpos = GameManager_multi.mainCam.ScreenToWorldPoint(wpos);
        ...
        var screenPtButton = GameManager_multi.mainCam.WorldToScreenPoint(buttonShouldBeHit.transform.position);
    ...
    {
        var wpos = finalPos;
        var mpos = GameManager_multi.mainCam.WorldToScreenPoint(wpos);
        var buttonShouldBeHit = this.buttonGo;
        var lineSprite = this.lineSprite;
